...
public class Connect4LogicTest {
    ...
    public void testChooseNextPlayer() {
        assertEquals('X', connect4.changeTurn('O'));
        assertEquals('O', connect4.changeTurn('X'));
    }
    ...
    public void testCheckTie() {
        ...
        assertEquals(true, connect4.checkTie(gridTie, 'X'));
        assertEquals(true, connect4.checkTie(gridTie, 'O'));
    ...
    public void testCheckWinner() {
        ...
        assertEquals(true, connect4.checkWinner(gridHorizontalX, 'X'));
        assertEquals(true, connect4.checkWinner(gridVeritcalX, 'X'));
        assertEquals(true, connect4.checkWinner(gridDiagonalUpX, 'X'));
        assertEquals(false, connect4.checkWinner(gridDiagonalDownX, 'O'));
        assertEquals(true, connect4.checkWinner(gridHorizontalO, 'O'));
        assertEquals(true, connect4.checkWinner(gridVeritcalO, 'O'));
        assertEquals(true, connect4.checkWinner(gridDiagonalUpO, 'O'));
        assertEquals(true, connect4.checkWinner(gridDiagonalDownO, 'O'));
