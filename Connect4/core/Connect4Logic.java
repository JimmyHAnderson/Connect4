...
// default constructor
     ...
     */
    public boolean checkTie(char[][] grid, char x) {
        // Check if any of the top cells are empty
        if (checkWinner(grid, 'X') || checkWinner(grid, 'O')) {
            return false; // If there's a winner, it's not a tie
        }

        // Then check if any of the top cells are empty
        ...
        // No winner and no empty spots, it's a tie
        return true;
    }
